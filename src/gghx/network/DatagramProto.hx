...
class DatagramProto<Handle> {
    ...
    public function onLoopPoll() {
        ...
        switch (state) {
            ...
            case Running(last_quality_report_time, last_network_stats_interval, last_input_packet_recv_time): {
                ...
                if (disconnect_timeout != 0 && disconnect_notify_start != 0 && !disconnect_notify_sent && (last_recv_time + disconnect_notify_start < nowv)) {
    ...
    public function onInputAck(msg: Msg,
        ack_frame: Int) {
    ...
    public function onQualityReport(msg: Msg,
        frame_advantage: Int, ping: Int) {
    ...
    public function onQualityReply(msg: Msg,
        pong: Int) {
