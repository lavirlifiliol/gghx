...
abstract class Session {
    ...
    public function setFrameDelay(player: PlayerHandle, delay: Int): Void {throw new GGError(UNSUPPORTED); }
    public function setDisconnectTimeout(timeout: Int): Void {throw new GGError(UNSUPPORTED); }
    public function setDisconnectNotifyStart(timeout: Int): Void { throw new GGError(UNSUPPORTED); }
}
